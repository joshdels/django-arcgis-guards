...
urlpatterns = [
    ...
    path("client-profile/contracts/<int:id>", views.client_contract, name="client_contract"),
    path("client-profile/guards/<int:id>", views.client_guard, name="client_guard"),
    path("client-profile/finances/<int:id>", views.client_finances, name="client_finances"),
    path("client-profile/reports/<int:id>", views.client_report, name="client_report"),
